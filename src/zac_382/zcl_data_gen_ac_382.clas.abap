class zcl_data_gen_ac_382 definition
  public
  final
  create public .
...
class zcl_data_gen_ac_382 implementation.
...
" testing new change in GitHub
    data: lt_acc_categ type table of ztb_acc_categ_lg,
          ...
          lt_clnts_lib type table of ztb_clnts_lib_lg,
          lt_libros    type table of ztb_libros_lgl.
...
******** ztb_acc_categ_lg ********
    ...
    delete from ztb_acc_categ_lg.
    insert ztb_acc_categ_lg from table @lt_acc_categ.
...
******** ztb_catego_lgl ********
    ...
    "Delete possible entries; insert new entries
    delete from ztb_catego_lgl.
    insert ztb_catego_lgl from table @lt_catego.
...
******** ztb_clientes_lgl ********
    ...
    "Delete possible entries; insert new entries
    delete from ztb_clientes_lgl.
    insert ztb_clientes_lgl from table @lt_clientes.
...
******** ztb_clnts_lib_lg
    ...
    "Delete possible entries; insert new entries
    delete from ztb_clnts_lib_lg.
    insert ztb_clnts_lib_lg from table @lt_clnts_lib.
...
******** ztb_libros_lgl ********
    ...
    'https://eltinteroeditorial.com/wp-content/uploads/2017/06/c%C3%B3mo-es-el-proceso-de-edici%C3%B3n.jpg' ) ).
    "Delete possible entries; insert new entries
    delete from ztb_libros_lgl.
    insert ztb_libros_lgl from table @lt_libros.
